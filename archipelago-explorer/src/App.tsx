...
export default function App() {
  ...
  const [spiralOrdering, setSpiralOrdering] = useState<SpiralFitOrdering>("sorted_log10_N"), [showSpiralOverlay, setShowSpiralOverlay] = useState(false);
  ...
  const spiral = useMemo(() => spiralFit(rows, spiralOrdering), [rows, spiralOrdering]);
